...
# Drive the connection string from app settings (.env / real env) rather than
...
async def run_async_migrations() -> None:
    ...
    # asyncpg-specific: disable its server-side prepared-statement cache, which
    # breaks against Neon's pooled (pgbouncer) endpoint. Only applies when the
